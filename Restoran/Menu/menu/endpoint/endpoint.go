...
type MenuEndpoint struct {
	...
	ReadMenuByKeteranganMenuEndpoint kit.Endpoint
}
...
func NewMenuEndpoint(service svc.MenuService) MenuEndpoint {
	...
	readMenuByKeteranganMenuEp := makeReadMenuByKeteranganMenuEndpoint(service)
	return MenuEndpoint{AddMenuEndpoint: addMenuEp,
		...
		ReadMenuByKeteranganMenuEndpoint: readMenuByKeteranganMenuEp,
	}
}
...
func makeReadMenuByKeteranganMenuEndpoint(service svc.MenuService) kit.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		req := request.(svc.Menu)
		result, err := service.ReadMenuByKeteranganMenuService(ctx, req.Keterangan)
		return result, err
	}
}
